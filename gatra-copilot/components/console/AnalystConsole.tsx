...
export function AnalystConsole() {
  ...
  useLangGraphInterrupt<ResponseGateEvent>({
    ...
    render: ({ event, resolve }) => (
      <ApprovalCard
        ...
        onApprove={() => resolve(JSON.stringify({ approved: true }))}
        onDeny={(reason: string) => resolve(JSON.stringify({ approved: false, reason }))}
      />
    ),
  });
